...
button.addEventListener("click", () => {
  ...
  if (select == "fibonacci") {
    ...
    displayOutput1.innerHTML = replaceVowel(userInput, generateFibonacci(userInput), typeOfSequence);
  } else if (select == "odd") {
    typeOfSequence = selectOdd.value;
    displayOutput2.innerHTML = replaceVowel(userInput, generateOdd(userInput), typeOfSequence);
  } else if (select == "even") {
    typeOfSequence = selectEven.value;
    displayOutput3.innerHTML = replaceVowel(userInput, generateEven(userInput), typeOfSequence);
  } else if (select == "numAlp") {
    typeOfSequence = selectNumAlp.value;
    displayOutput4.innerHTML = replaceVowel(userInput, generateNumber(userInput), typeOfSequence, generateAlphabet(userInput));
  }
